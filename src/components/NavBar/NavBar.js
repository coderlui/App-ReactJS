...
import "./NavBar.css";
import CartWidgetandCounter from '../cartWidget';
        ...
        <>
          <header>
            <div className="alerta" role="alert">
              <strong>Quieres un descuento?</strong> Utiliza nuestro codigo OCT2021% para activar el 15% off sobre el total de tu compra.
              </div>
              
              <img src ="p.png" className="navigationImg" alt="Store's Logo"/>
